...
# Image mappings
item_images = {
    'MM-REPOS-00127-00': '/assets/images/skf_6204_bearing_intact_1788638178941.jpg',
    ...
    'MM-REPOS-00142-00': '/assets/images/skf_6204_bearing_intact_1788638178941.jpg',
    'MM-REPOS-00096-00': '/assets/images/skf_6204_bearing_intact_1788638178941.jpg',
...
for fpath in ocr_files:
    with open(fpath, 'r', encoding='utf-8') as f:
        for line in f:
            ...
            # Fix OCR missing initial 'R' on bearings
            if desc.startswith("OLAMENTO"):
                desc = "R" + desc
                standard_cat = "ROLAMENTOS"
                if "SKF" in desc and not found_mfg:
                    found_mfg = "SKF"
...
# Ensure essential bearings are in catalog
if 'MM-REPOS-00127-00' not in seen_codes:
    seen_codes.add('MM-REPOS-00127-00')
    catalog_items.append({
        'id': f'item-{item_counter}',
        'codigo': 'MM-REPOS-00127-00',
        'descricao': 'ROLAMENTO RÍGIDO DE ESFERAS SKF 6204 2RSL (20 x 47 x 14 mm)',
        'categoria': 'ROLAMENTOS',
        'fabricante': 'SKF',
        'dimensao': '20 x 47 x 14 mm',
        'palavrasChave': ['00', '00127', '14mm', '20', '2rsl', '47', '6204', 'esferas', 'mm', 'repos', 'reposição', 'rigido', 'rolamento', 'skf'],
        'status': 'disponivel',
        'dataCriacao': '2025-01-15',
        'imagemUrl': '/assets/images/skf_6204_bearing_intact_1788638178941.jpg',
        'documentos': item_docs.get('MM-REPOS-00127-00', []),
        'favorito': True
    })
    item_counter += 1

if 'MM-REPOS-00136-00' not in seen_codes:
    seen_codes.add('MM-REPOS-00136-00')
    catalog_items.append({
        'id': f'item-{item_counter}',
        'codigo': 'MM-REPOS-00136-00',
        'descricao': 'ROLAMENTO FIXO DE ESFERAS SKF 6306 2RS (30 x 72 x 19 mm)',
        'categoria': 'ROLAMENTOS',
        'fabricante': 'SKF',
        'dimensao': '30 x 72 x 19 mm',
        'palavrasChave': ['00', '00136', '19mm', '2rs', '30', '6306', '72', 'esferas', 'fixo', 'mm', 'repos', 'reposição', 'rolamento', 'skf'],
        'status': 'disponivel',
        'dataCriacao': '2025-01-15',
        'imagemUrl': '/assets/images/bearing_skf_6306_1788569563132.jpg',
        'documentos': item_docs.get('MM-REPOS-00136-00', []),
        'favorito': True
    })
    item_counter += 1
