        ...
        <div className="lg:col-span-6 flex flex-col space-y-3">
          <div className="bg-white border border-slate-200 rounded-lg p-5 sm:p-6 shadow-xs flex flex-col items-center justify-between min-h-[400px]">
            ...
            <div className="w-full flex-1 flex items-center justify-center p-2 min-h-[260px]">
              <div className="w-full h-72 flex flex-col items-center justify-center p-2 relative">
                <img
                  src={item.imagemUrl || getTechnicalPlaceholder(item)}
                  alt={item.descricao}
                ...
                />
                {!item.imagemUrl && (
                  <span className="absolute bottom-1 text-[9px] font-mono tracking-widest text-slate-400 uppercase">
                    VISTA TÉCNICA DE REFERÊNCIA
                  </span>
                )}
              </div>
            </div>
