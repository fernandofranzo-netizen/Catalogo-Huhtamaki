...
export function downloadSampleExcel() {
  const sampleData = [
    ...
    {
      'CÓDIGO': 'MM-PNEUM-00191-00',
      'DESCRIÇÃO': 'VALVULA PNEUM DIREC 1/4BSP FESTO/VL51/4B',
      'CATEGORIA': 'MATERIAL MECÂNICO',
      'FABRICANTE': 'FESTO',
      'DIMENSÃO': '1/4 pol BSP',
      'LOCALIZAÇÃO': 'Prateleira Pneumática C-02',
      'PALAVRAS_CHAVE': 'valvula, pneumatica, festo, direcionada, ar comprimido',
      'IMAGEM_URL': 'https://images.unsplash.com/photo-1581092160607-ee22621dd758?auto=format&fit=crop&w=800&q=80',
    },
    {
      'CÓDIGO': 'ME-CPELE-00256-00',
      'DESCRIÇÃO': 'SENSOR PROX INDUT 4MM NA PNP',
